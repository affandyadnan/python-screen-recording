...
def main_l():
    ...
    def ghb():
        try:
            webbrowser.open("https://github.com/affandyadnan")
    ...
    Button(t, text="By Affandy Adnan",  font=('Comic sans MS',13) , command=ghb, background="black",foreground="white", activebackground="white", activeforeground="black").place(x=10,y=210)
    p1.place(x=15,y=80)
